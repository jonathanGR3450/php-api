...
<body>
    <div class="container my-4">
        ...
        <div class="row mt-4" id="div-customer-form" style="display: none;">
            <div class="col-12">
                <h3>Customer Form</h3>
            </div>
            <div class="col-12">
                <form id="customer-form">
                    ...
                    <input type="hidden" name="customerNumber" id="customerNumber" value="-1">
        ...
        <div class="row mt-4" id="div-table-orders">
            ...
            <div class="col-12">
                ...
                <button type="button" id="btn-new-order" class="btn btn-primary">New Order</button>
            </div>
        </div>
